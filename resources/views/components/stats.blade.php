              ...
              <div class="col-lg-10">
                  <div class="stats-wrapper">
                      <div class="stats-item" data-aos="zoom-in" data-aos-delay="150">
                          ...
                          <span data-purecounter-start="0" data-purecounter-end="{{ $data->happy_clients }}" data-purecounter-duration="1"
                      ...
                      <div class="stats-item" data-aos="zoom-in" data-aos-delay="250">
                          ...
                          <span data-purecounter-start="0" data-purecounter-end="{{ $data->hours }}" data-purecounter-duration="1"
                              class="purecounter"></span>
                      ...
                      <div class="stats-item" data-aos="zoom-in" data-aos-delay="300">
                          ...
                          <span data-purecounter-start="0" data-purecounter-end="{{ $data->partners }}" data-purecounter-duration="1"
                              class="purecounter"></span>
                          <p>Hard Workers</p>
                      </div><!-- End Stats Item -->
                  </div>
