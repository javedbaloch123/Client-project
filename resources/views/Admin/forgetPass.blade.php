                            ...
                            <div class="card">
                                <div class="card-body p-0 bg-black auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        ...
                                        <h2 class="mt-3 mb-1 fw-semibold text-white ">Change password</h2>
                                        {{-- <p class="text-muted fw-medium mb-0">Sign in</p>   --}}
                                    </div>
                                </div>
                                <div class="card-body pt-0">

                                    <form class="my-4" action="{{ route('password.process') }}" method="POST">
                                        @if (session('message'))
                                        ...
                                        <div class="form-group mb-2">
                                           ...
                                           <div class="form-group mb-2">
                                            ...
                                            <input type="password" class="form-control" id="confirmation_password" name="cpass"
